...
fn add_base_context_rules<'a>(
    ...
    match phase {
        "trace" => {
            must.push(("Trace specification", "docs/harness/TRACE_SPEC.md"));
        ...
        "implementation" => {
            ...
            if lane == "normal" || lane == "high_risk" {
                ...
                should.push(("Architecture rules", "docs/architecture/overview.md"));
            }
            if lane == "high_risk" {
                must.push(("Architecture rules", "docs/architecture/overview.md"));
                must.push((
                    "High-risk story template",
                    "docs/harness/templates/stories/high-risk/",
                ));
            }
        }
        "planning" => {
            ...
            if lane == "normal" || lane == "high_risk" {
                must.push(("Story template", "docs/harness/templates/stories/story.md"));
                must.push(("Test matrix", "docs/validation/test-matrix.md"));
            }
            if lane == "high_risk" {
                must.push((
                    "High-risk story template",
                ...
                must.push(("Harness maturity", "docs/harness/HARNESS_MATURITY.md"));
            }
        }
        _ => {
            must.push(("Agent entrypoint", "AGENTS.md"));
            must.push(("Feature intake", "docs/harness/FEATURE_INTAKE.md"));
            must.push(("Durable matrix", "scripts/bin/harness-cli query matrix"));
            if lane == "tiny" {
                skipped.push("docs/architecture/overview.md");
            } else {
                must.push(("README", "README.md"));
                must.push(("Harness operating model", "docs/harness/HARNESS.md"));
            }
        }
    }
}
